...
define('COOKIE_DOMAIN', '.achchuthan.info'); // the domain where the cookie is valid for, like '.mydomain.com'
...
define("EMAIL_PASSWORDRESET_URL", "http://www.achchuthan.info/administer/advanced/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "noreply@achchuthan.info");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Lab Utilization | University of Jaffna");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Lab Utilization");
...
define("EMAIL_VERIFICATION_URL", "http://www.achchuthan.info/administer/advanced/register.php");
define("EMAIL_VERIFICATION_FROM", "noreply@labutil.tk");
define("EMAIL_VERIFICATION_FROM_NAME", "Lab Utilization | University of Jaffna");
define("EMAIL_VERIFICATION_SUBJECT", "Account Activation for Lab Utilization");
