        ...
        if (isset($_COOKIE['rememberme'])) {
            ...
            if ($hash == hash('sha256', $user_id . ':' . $token . COOKIE_SECRET_KEY) && !empty($token)) {
                ...
                if ($this->databaseConnection()) {
                    ...
                    $sth = $this->db_connection->prepare("SELECT user_id, user_name, user_email,user_district FROM users WHERE user_id = :user_id
                    ...
                    if (isset($result_row->user_id)) {
						...
						$_SESSION['user_district'] = $result_row->user_district;
						...
						$this->user_district = $result_row->user_district;
                        $this->user_is_logged_in = true;
